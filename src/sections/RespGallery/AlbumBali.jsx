...
import pic7 from '../RespGallery/photos/indonesia/bali7.jpg';
import pic8 from '../RespGallery/photos/indonesia/bali8.jpg';
  ...
  return (
    <div className="container">
      ...
      <div className="titleDiv">
        ...
        <h2 className="title">indonesia</h2> {/* Gallery title */}
